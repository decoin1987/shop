...
const {data: product, status: productStatus, refresh: productRefresh} = useFetch(`/api/catalog/product/${route.params.id}`)

const {data: images, pending: imagePending, refresh: imageRefresh} = useFetch(`/api/catalog/product/${route.params.id}/images`)
