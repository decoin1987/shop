  ...
  <UForm :state="props.product" class="flex w-full flex-col gap-3">
    <div class="flex frex-row w-full gap-4">
      ...
      <UFormGroup class="w-full" label="Налог">
        <USelect v-model="props.product.price" size="xl" placeholder="Налог"/>
      </UFormGroup>
    </div>
    <div class="flex frex-row w-full gap-4">
