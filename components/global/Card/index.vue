  ...
  <UCard as="article" :ui="card_ui" tag="article">
    <template #header>
      <div class="relative">
        ...
        <img class="rounded-sm rounded-tl-card w-full" style="aspect-ratio: 3/4; object-fit: cover" :src="`${props.product.product_images?.length ? '/img/product/' + props.product.product_images[0].url : '/img/common/nophoto.png'}`" alt="">
